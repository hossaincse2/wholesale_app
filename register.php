...
if(isset($_POST['register'])){
    $data = [
            ...
            'user_type' => $user->escape_string($_POST['user_type']),
            'mobile' => $user->escape_string($_POST['mobile']),
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <?php if (isset($auth['status'])){ ?>
                                    <div class="alert <?php echo $auth['status'] ? 'alert-success' : 'alert-danger'?>" role="alert">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputMobile" type="text" name="mobile" placeholder="Mobile Number" />
